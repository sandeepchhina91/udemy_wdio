export const config = {
    ...
    before: function (capabilities, specs) {
        browser.addCommand('customFileUpload',async(filePath,fileInput,radioButton,uploadButton)=>{
        ...
        browser.addCommand('sauceLogin',async()=>{
            await $('.login_logo').waitForDisplayed()
        ...
        browser.addCommand('sauceLogout',async()=>{
            await $("//button[normalize-space()='Open Menu']").Click()
